...
define(['dojo/_base/declare',
  ...
  function(declare, lang, array, html, Deferred, topic, Evented, on, aspect,
    json, query, xhr, all, utils, tokenUtils, Message, portalUrlUtils, portalUtils) {
    var instance = null,
      clazz = declare(Evented, {
              ...
              .then(lang.hitch(this, function(results) {
                ...
                this.loadWidgetResources(setting).then(lang.hitch(this, function(resouces) {
                  try {
                    ...
                    new Message({
                      message: window.jimuNls.createWidgetError + ': ' + setting.uri
                    });
                    def.reject(err);
                  }
        ...
        createWidget: function(setting, clazz, resouces) {
          ...
          //   setting.sceneView = this.map.view;
          // }
          setting.sceneView = this.sceneView;
          ...
          then(lang.hitch(this, function(results) {
            ...
            this.loadWidgetSettingPageResources(setting).then(lang.hitch(this, function(resources) {
              ...
              try {
                ...
                new Message({
                  message: window.jimuNls.createWidgetSettingError + ':' + setting.uri
                });
                def.reject(err);
              }
            }), function(err) {
          ...
          var file, hasp,
            ...
            doLoad = function() {
              ...
              loadDef.then(function(data) {
                ...
                console.error(err);
                new Message({
                  message: window.jimuNls.loadWidgetResourceError + ': ' + setting.uri
                });
                def.reject(err);
              });
            };
