  ...
  function(ConfigManager, LayoutManager, DataManager, html, lang, array, on, mouse, topic, cookie,
    ...
    io.interceptors = [{
      before: function(params){
        ...
        if (parentHttps) {
          var patt = /^http(s?):\/\//gi;
          params.url = params.url.replace(patt, 'https://');
        }
    ...
    window.wabVersion = '2.27';
    // window.productVersion = '2023 R01';
    window.productVersion = 'ArcGIS Web AppBuilder (Developer Edition) 2.27';
