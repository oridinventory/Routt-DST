...
define([
  ...
  function(declare, lang, array, html, when, on, /*aspect,*/ query, keys, Deferred, all,
    BaseWidget, /*LayerInfos,*/ jimuUtils, Search, SearchViewModel, FeatureQuery,
    ...
    return declare([BaseWidget], {
      ...
      startup: function() {
        ...
        when(utils.getConfigInfo(this.config)).then(lang.hitch(this, function(config) {
          ...
          */
          ...
          this.own(
            on(this.searchDijit, 'suggest-complete', lang.hitch(this, '_onSuggestResults'))
          );
            ...
            if(resultFeature) {
              ...
              */
              if(layerView.layer.type === "scene") {
                this.sceneView.goTo(resultFeature);
              }
            }
          }));
        }
      ...
      _onSuggestResults: function() {
        ...
        setTimeout(lang.hitch(this, function() {
          var suggestionsMenu = query('.esri-search__suggestions-menu', this.domNode)[0];
          if(count++ >= 10) {
            return;
          } else if(suggestionsMenu) {
            this._resetSelectorPosition('.esri-search__suggestions-menu');
          } else {
            setTimeout(lang.hitch(this, arguments.callee), 10); // jshint ignore:line
          }
        }), 10);
      },
    ...
    */
      ...
      _onSearchDijitClick: function() {
        this._resetSelectorPosition('.esri-search__sources-menu');
        this._onSuggestResults();
      },
      ...
      _resetSelectorPosition: function(cls) {
        ...
        query(cls, this.domNode).forEach(lang.hitch(this, function(menu) {
          ...
          //if (sc > 1 && cls === '.esri-search__sources-menu') {
          ...
          //}
          if (html.getStyle(menu, 'display') === 'none' || html.getStyle(menu, 'visibility') === 'hidden') {
            return;
          }
