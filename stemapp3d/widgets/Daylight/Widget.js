...
define([
  ...
  ], function(declare, BaseWidget, _WidgetsInTemplateMixin, on, lang, html, jimuUtils, reactiveUtils) {
    ...
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      _init: function() {
        ...
        if(lighting.directShadowsEnabled !== undefined){
          showShadowContainer = true;
          var directShadowLabel = this.nls.directShadow + "&lrm;";
          this.cbxDirect.setLabel(directShadowLabel);
          this.own(reactiveUtils.watch(lang.hitch(this, function () {
            return this.sceneView.environment.lighting.directShadowsEnabled
