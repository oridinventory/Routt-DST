...
define([
  ...
  function (declare, array, lang, on, kernel, domStyle, ColorPickerEditor, FontSetting, _WidgetsInTemplateMixin,
    LayerStructure, BaseWidgetSetting, TabContainer, LoadingShelter, dijitRegistry, query) {
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      postCreate: function () {
        ...
        if (window.isRTL && kernel.locale === "he") {
          domStyle.set(this.helpBtn, "transform", "rotateY(0deg)");
        } else {
