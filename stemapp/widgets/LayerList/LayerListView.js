...
define([
  ...
  'dojo/dom-style',
  './NlsStrings'
], function(_WidgetBase, declare, lang, array, domConstruct,ArcGISDynamicMapServiceLayer, on, query,
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
	...
	console.log(layerInfo);
	  ...
	  /////////
	  switch (ckSelect.checked) {
    case true:
	          layerInfo.setTopLayerVisible(true);
	           console.log("true");
              if (!layerInfo.isRootLayer()){
			    if  (!layerInfo.parentLayerInfo.isVisible()){
                 layerInfo.parentLayerInfo.setTopLayerVisible(ckSelect.checked);}
				 if  (layerInfo.parentLayerInfo.parentLayerInfo && !layerInfo.parentLayerInfo.parentLayerInfo.isVisible()){
                 layerInfo.parentLayerInfo.parentLayerInfo.setTopLayerVisible(ckSelect.checked);}
				 console.log("layerInfo.parentLayerInfo.parentLayerInfo");
				 console.log(layerInfo.parentLayerInfo.parentLayerInfo);
				 if  (layerInfo.parentLayerInfo.parentLayerInfo.parentLayerInfo && !layerInfo.parentLayerInfo.parentLayerInfo.parentLayerInfo.isVisible()){
                 layerInfo.parentLayerInfo.parentLayerInfo.parentLayerInfo.setTopLayerVisible(ckSelect.checked);}
				if (!layerInfo.originOperLayer.mapService.layerInfo.isVisible()){
		         layerInfo.originOperLayer.mapService.layerInfo.setTopLayerVisible(ckSelect.checked); 
			}
		      }else{
