define({
  ...
  "unableToUseLocator": "O localizador não está acessível. As ações do atributo de endereço não serão executadas. Clique em OK para continuar a editar.",
  ...
  "noVisibleCreateLayerWarning": "Camadas não visíveis ao nível de zoom atual. Aumente ou diminua o zoom para criar/modificar elementos.",
  "noVisibleUpdateLayerWarning": "Camadas não visíveis ao nível de zoom atual. Aumente ou diminua o zoom para modificar elementos.",
  ...
  "copyFeatures": {
    ...
    "canNotSaveMultipleFeatureWarning": "Só pode copiar um elemento quando a camada de pontos de destino tiver campos de valor exclusivos.",
    "createOnlyOneMultipartFeatureWarning": "Só pode copiar um elemento ou criar um elemento de múltiplas partes quando a camada de destino tiver campos de valor exclusivos.",
    ...
    "directionsRouteLabel": "Rotas de Direções",
    "directionsWaypointsLabel": "Pontos de Rota de Direções",
    "diretionsStopLabel": "Paragens de Direções"
  },
  ...
  "relativeDates": {
    ...
    "valueProviderHint": "Nota: os valores a selecionar podem não estar disponíveis se o utilizador não tiver os privilégios necessários."
  },
  "valuePicker": {
    "popupTitle": "Selecionar Valor",
  ...
  "fieldsMapping": {
    "popupTittle": "Aplicar Correspondência de Campos",
