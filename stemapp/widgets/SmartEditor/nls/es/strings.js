define({
  ...
  "noFeatureInAIWarning": "No se han seleccionado entidades. Seleccione una entidad para realizar ediciones o haga clic en cancelar para volver a la pantalla principal.",
  ...
  "noVisibleCreateLayerWarning": "Capas no visibles en el nivel de zoom actual. Acérquese o aléjese para crear/modificar entidades.",
  "noVisibleUpdateLayerWarning": "Capas no visibles en el nivel de zoom actual. Acérquese o aléjese para modificar entidades.",
  ...
  "copyFeatures": {
    ...
    "directionsRouteLabel": "Ruta de indicaciones",
    "directionsWaypointsLabel": "Puntos de referencia de ruta de indicaciones",
    "diretionsStopLabel": "Paradas de indicaciones"
  },
  ...
  "relativeDates": {
    ...
    "valueProviderHint": "Nota: es posible que los valores para seleccionar no estén disponibles si el usuario no tiene los privilegios necesarios."
  },
  "valuePicker": {
    "popupTitle": "Seleccione un valor",
  ...
  "fieldsMapping": {
    ...
    "fieldsMatchingCheckboxLabel": "Los valores de las entidades copiadas invalidan los valores predeterminados en los campos de destino",
