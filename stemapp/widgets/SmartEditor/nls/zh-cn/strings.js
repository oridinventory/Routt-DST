define({
  ...
  "noFeatureInAIWarning": "未选择要素。 请选择要执行编辑的要素，或单击“取消”返回至主屏幕。",
  "noEditableLayerWarning": "您的帐户无权创建或修改数据，或者此 web 地图不包含任何可编辑图层。",
  "noVisibleCreateLayerWarning": "图层在当前缩放级别不可见。 缩放以创建/修改要素。",
  "noVisibleUpdateLayerWarning": "图层在当前缩放级别不可见。 缩放以修改要素。",
  ...
  "copyFeatures": {
    ...
    "canNotSaveMultipleFeatureWarning": "当目标点图层具有唯一值字段时，仅可复制一个要素。",
    "createOnlyOneMultipartFeatureWarning": "当目标图层具有唯一值字段时，仅可复制一个要素或创建一个多部分要素。",
    "layerLabel": "${layerName} (${selectedFeatures}/${totalFeatures})",
    "layerAriaLabel": "${layerName} ${selectedFeatures}/${totalFeatures} 个要素已选择",
    "geometryLabel": "几何",
    "directionsRouteLabel": "方向路径",
    "directionsWaypointsLabel": "方向路径航路点",
    "diretionsStopLabel": "方向停靠点"
  },
  ...
  "relativeDates": {
    ...
    "valueProviderHint": "注：如果用户不具有所需的权限，则可供选择的值可能不可用。"
  },
  "valuePicker": {
    "popupTitle": "选择值",
  ...
  "fieldsMapping": {
    "popupTittle": "应用字段匹配",
    "fieldsMatchingCheckboxLabel": "复制要素中的值会覆盖目标字段中的默认值",
    "resetLabel": "重置",
    "clearLabel": "清除",
