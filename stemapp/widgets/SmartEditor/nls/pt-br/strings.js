define({
  ...
  "copyFeatures": {
    ...
    "directionsRouteLabel": "Direções da Rota",
    "directionsWaypointsLabel": "Pontos de Referência de Direções da Rota",
    "diretionsStopLabel": "Direções das Paradas"
  },
  ...
  "relativeDates": {
    ...
    "valueProviderHint": "Nota: Os valores a serem selecionados podem não estar disponíveis se o usuário não tiver os privilégios necessários."
  },
  "valuePicker": {
    "popupTitle": "Selecionar Valor",
  ...
  "fieldsMapping": {
    ...
    "fieldsMatchingCheckboxLabel": "Os valores das feições copiadas substituem os valores padrão nos campos de destino",
