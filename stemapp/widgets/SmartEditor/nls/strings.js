define({
  root: ({
    ...
    unableToUseLocator: "Locator is not accessible. The address attribute actions will not be performed. Click OK to continue editing.",
    ...
    noFeatureInAIWarning: "No features selected. Please select a feature to perform edits or click cancel to return to the main screen.",
    ...
    noVisibleCreateLayerWarning: "Layers not visible at the current zoom level. Zoom in or out to create/modify features.",
    noVisibleUpdateLayerWarning:"Layers not visible at the current zoom level. Zoom in or out to modify features.",
    ...
    copyFeatures: {
      ...
      directionsRouteLabel: "Directions Route",
      directionsWaypointsLabel: "Directions Route Waypoints",
      diretionsStopLabel: "Directions Stops"
    },
    ...
    relativeDates: {
      ...
      valueProviderHint: "Note: Values to select from may not be available if the user does not have the required privileges."
    },
    valuePicker: {
      popupTitle: "Select Value",
    ...
    fieldsMapping: {
      ...
      fieldsMatchingCheckboxLabel: "Values from copied features override default values in target fields",
      resetLabel: "Reset",
      clearLabel: "Clear",
