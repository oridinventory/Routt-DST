      ...
      _createFieldMap: function (sLayerDetails, targetLayerDetails) {
        ...
        array.forEach(targetLayerDetails.fields, lang.hitch(this, function (targetField) {
          ...
          if (targetField.type !== "esriFieldTypeGeometry" &&
            ...
            //if graphic layer dont have any attributes then dont create mapping table
            //and show to matchno fields  message
            if (sLayerDetails.fields && sLayerDetails.fields.length === 0) {
              isMappingTableCreated = false;
            }
