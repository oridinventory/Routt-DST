...
define([
  ...
  return declare([BaseWidget, Evented, _WidgetsInTemplateMixin], {
    ...
    postCreate: function () {
      ...
      var costingInfoHintText = utils.stripHTML(this.nls.workBench.costingInfoHintText);
      domAttr.set(this.costEquationHint, "aria-label", costingInfoHintText);
    },
    ...
    _onOkButtonClicked: function () {
      ...
      if (this._groupInfo.scenario !== selectedScenario.scenario ||
        this._groupInfo.equation.toLowerCase() !==
        this.newCostEquationValue.get('value').toLowerCase()) {
        updatedGroupInfo = {
          "templateInfo": {
    ...
    _onEquationChange: function () {
      ...
      value = utils.sanitizeHTML(this.newCostEquationValue.get('value'));
    ...
    setGroupInfo: function (groupInfo) {
      ...
      this._add508SupportCostEquationEditor();
    },
    ...
    */
    ...
    /**
    * This function is used to set first and last focus node in cost equation panel
    */
    _add508SupportCostEquationEditor: function () {
      utils.initFirstFocusNode(this.widgetDomNode, this.geographyValue.textbox);
      focusUtils.focus(this.geographyValue.textbox);
      utils.initLastFocusNode(this.widgetDomNode, this.cancelButton);
    }
  });
});