define({
  root: ({
    ...
    "unabletoWriteToLayer": "Unable to publish to existing layer due to insufficient permissions. A new layer will be created in your organization",
    ...
    "invalidRangeMessage": "Value must be between 0 - 359", //Shown as validation error on invalid entries
